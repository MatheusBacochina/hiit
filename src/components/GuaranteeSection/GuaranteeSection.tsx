...
export const GuaranteeSection = () => {
  return (
    <div className="mt-32 flex justify-center bg-neutral-800 px-6">
      <div className="flex max-w-[1066px] items-center gap-14 py-4 max-lg:flex-col-reverse max-lg:gap-8  ">
